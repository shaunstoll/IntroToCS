...
public class Library {
	...
	private static class Patrons {
		...
		Map<Patron, List<BookInstance>> patronToRentals = new HashMap<>();
		Map<Patron, List<BookInstance>> patronToReserves = new HashMap<>();
	}
	...
	public void borrow(Patron patron, BookInstance book) throws OnLoanException {
		...
		List<BookInstance> rentals = patrons.patronToRentals.get(patron);
		rentals.add(book);
	...
	public Set<BookInstance> onReserve(Patron patron) {
		...
		return patrons.patronToReserves.get(patron);
	}
